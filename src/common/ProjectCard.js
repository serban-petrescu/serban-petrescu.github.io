                ...
                <div className="card-meta-right">
                    ...
                    }
                    {
                        facebook && <Button circular color='facebook' icon='facebook' size='mini' as='a' 
                            href={facebook} title='FaceBook Page' target='_blank'  />
                    }
                    {
